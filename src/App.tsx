...
export default function App() {
  ...
  // Offline weather & UV data
  const weather: WeatherData = {
    city: userState.profile.city || 'تهران',
    temp: 26,
    conditionFa: 'آفتابی و معتدل',
    humidity: 35,
    uvIndex: 6,
    recommendationFa: 'شاخص UV خورشید امروز ۶ (بالا) است. استفاده از ضدآفتاب و تجدید آن توصیه می‌شود.',
  };
