...
export const DEFAULT_USER_STATE: UserState = {
  profile: {
    ...
    skinTone: 'medium',
    sensitivityScore: 5,
    primaryConcerns: ['acne', 'hyperpigmentation', 'oiliness'],
    hairType: 'wavy',
    hairConcerns: ['خشکی ساقه', 'چربی کف سر'],
    isPregnant: false,
  ...
  cycleConfig: {
    enabled: true,
    lastPeriodDate: getTodayIsoDate(),
    cycleLength: 28,
    periodLength: 5,
    regularity: 'regular',
    pmsStartDaysBefore: 7,
  },
  userXp: 120,
  userLevel: 2,
  currentStreakDays: 3,
...
export const SKIN_CONDITIONS_DATABASE: SkinConditionInfo[] = [
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1512290900673-c15cfa959a72?auto=format&fit=crop&w=800&q=80',
  },
  {
    id: 'cond_rosacea',
...
export const DEFAULT_PRODUCTS: Product[] = [
  {
    id: 'prod_1',
    name: 'ژل شوینده سالیسیلیک اسید نوتروژینا',
    brand: 'Neutrogena',
    category: 'cleanser',
    ingredients: ['Salicylic Acid', 'Glycerin'],
    owned: true,
    rating: 5,
    notes: 'عالی برای پاکسازی منافذ و کنترل چربی در فاز PMS',
    usageInstructionsFa: 'روزانه یک الی دو بار روی پوست مرطوب ماساژ داده و سپس آبکشی کنید.'
  },
  {
    id: 'prod_2',
    name: 'سرم نیاسینامید ۱۰٪ و زینک ۱٪ اوردینری',
    brand: 'The Ordinary',
    category: 'serum',
    ingredients: ['Niacinamide', 'Zinc PCA'],
    owned: true,
    rating: 5,
    notes: 'کنترل کامل چربی و کم‌رنگ کردن جای جوش‌ها',
    usageInstructionsFa: 'چند قطره صبح و شب قبل از مرطوب‌کننده روی صورت استفاده شود.'
  },
  {
    id: 'prod_3',
    name: 'کرم مرطوب‌کننده آبرسان سرامید لاروش پوزای',
    brand: 'La Roche-Posay',
    category: 'moisturizer',
    ingredients: ['Ceramides', 'Niacinamide', 'Glycerin'],
    owned: true,
    rating: 5,
    notes: 'ترمیم سد دفاعی و آبرسانی عالی',
    usageInstructionsFa: 'پس از سرم یا شوینده روی پوست صورت و گردن ماساژ دهید.'
  },
  {
    id: 'prod_4',
    name: 'ضدآفتاب بی‌پیدایش ایزدین SPF 50',
    brand: 'ISDIN',
    category: 'sunscreen',
    ingredients: ['Sunscreen Filters', 'Hyaluronic Acid'],
    owned: true,
    rating: 5,
    notes: 'بافت مایع و بی‌رنگ سبک، عالی برای زیر آرایش',
    usageInstructionsFa: 'هر روز صبح ۲۰ دقیقه قبل از خروج از منزل استفاده کرده و هر ۲ ساعت تجدید کنید.'
  }
];
...
export const INITIAL_ACHIEVEMENTS: Achievement[] = [
  {
    id: 'ach_streak_7',
    titleFa: '۷ روز مراقبت مداوم',
    descriptionFa: 'ثبت و انجام کامل روتین روزانه برای ۷ روز متوالی',
    iconName: 'Flame',
    xp: 100,
    target: 7,
    current: 3,
  ...
  {
    id: 'ach_cycle_1',
    titleFa: 'شناخت چرخه پوست',
    descriptionFa: 'ردیابی تغییرات پوست در یک چرخه کامل ۲۸ روزه',
    iconName: 'Moon',
    xp: 200,
    target: 28,
    current: 12,
  ...
  },
  {
    id: 'ach_sun_shield',
    titleFa: 'محافظ آفتاب',
    descriptionFa: 'استفاده مداوم از ضدآفتاب برای ۱۰ روز ثبت شده',
    iconName: 'Sun',
    xp: 150,
    target: 10,
    current: 4,
  ...
  {
    id: 'ach_water_master',
    titleFa: 'هیدراتاسیون طلایی',
    descriptionFa: 'رسیدن به هدف ۸ لیوان آب برای ۵ روز',
    iconName: 'Droplet',
    xp: 100,
    target: 5,
    current: 2,
...
export const INITIAL_CHALLENGES: Challenge[] = [
  {
    id: 'ch_pms_care',
    titleFa: 'چالش مراقبت ویژه فاز PMS',
    descriptionFa: 'در ۵ روز قبل از پریود، روتین ضدجوش و آرام‌بخش را دقیق اجرا کنید.',
    categoryFa: 'چرخه و هورمون',
    targetDays: 5,
    currentDays: 2,
    completed: false,
    rewardXp: 150
  ...
  {
    id: 'ch_water_7',
    titleFa: 'چالش ۸ لیوان آب روزانه',
    descriptionFa: 'برای ۷ روز متوالی هدف آب‌رسانی بدن خود را کامل کنید.',
