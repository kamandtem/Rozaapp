  ...
  return (
    <div className="min-h-screen bg-[#faf8f5] flex items-center justify-center p-4">
      <div className="w-full max-w-md p-6 rounded-3xl bg-white border border-[#ebe0d4] shadow-xl text-right space-y-6">
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
            ...
            <div className="p-4 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-950 text-xs space-y-1">
              <div className="flex items-center gap-1.5 font-bold text-emerald-800">
                ...
                تعهد حریم خصوصی ۱۰۰٪ آفلاین
              </div>
              <p className="text-[11px] leading-relaxed opacity-90">
                هیچ اطلاعات شخصی، چرخه ماهانه یا عکسی از گوشی شما خارج نمی‌شود. تمام محاسبات به صورت کاملاً آفلاین رو خود دستگاه انجام می‌شوند.
              </p>
            </div>
        ...
        {step === 2 && (
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
            <h2 className="text-lg font-black text-[#2e2621]">انتخاب نوع پوست شما</h2>
        ...
        {step === 3 && (
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
            ...
            >
              ...
              تولید روتین اختصاصی و ورود به داشبورد
            </button>
          </motion.div>
        )}
      </div>
